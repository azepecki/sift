...
define dso_local i8* @str_add(i8* %0, i8* %1) #0 {
  ...
  %16 = sub i64 %15, 1
  %17 = call i8* @strncpy(i8* %12, i8* %13, i64 %16) #4
  ...
  %23 = sub i64 %22, 1
  %24 = call i8* @strncat(i8* %18, i8* %20, i64 %23) #4
...
39:                                               ; preds = %16
  ...
  %46 = call i8* @strtok(i8* %45, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #4
...
50:                                               ; preds = %47
  ...
  %58 = call i8* @strtok(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #4
